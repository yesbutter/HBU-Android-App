package com.example.qq1296821114.time_and_money.Card;
...
public class SwipeTimeAdapterView extends BaseFlingAdapterView {
    ...
    public SwipeTimeAdapterView(Context context) {
        this(context, null);
    }

    public SwipeTimeAdapterView(Context context, AttributeSet attrs) {
        this(context, attrs, R.attr.SwipeFlingStyle);
    }

    public SwipeTimeAdapterView(Context context, AttributeSet attrs, int defStyle) {
     ...
     */
    public void init(final Context context, MoneyCardAdapter mAdapter) {
...
//        makeAndAddView(newUnderChild);
    ...
    private void makeAndAddView(View child) {
        TextView textView=child.findViewById(R.id.parms_time);

//        LinearLayout.LayoutParams params = new LinearLayout.LayoutParams(LinearLayout.LayoutParams.MATCH_PARENT, LinearLayout.LayoutParams.MATCH_PARENT);
        FrameLayout.LayoutParams lp = new FrameLayout.LayoutParams(textView.getLayoutParams());
    ...
    @Override
    public TimeCardAdapter getAdapter() {
        return mAdapter;
    }
    ...
    public void setAdapter(TimeCardAdapter adapter) {
