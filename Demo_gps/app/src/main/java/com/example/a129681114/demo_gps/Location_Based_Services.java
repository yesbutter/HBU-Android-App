...
public class Location_Based_Services {
     ...
     */
    public static void addLoationListener(Context context,String provider,ILocationListener locationListener)
    {
        addLoationListener(context,provider,locationListener);
    }
